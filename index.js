...
class Person {
  ...
  eat(someFood) {
    this.stomach.length < 10 ? this.stomach.push(someFood) : this.stomach.length = 10;
  }
  poop() {
    this.stomach = [];
  }
...
/*
  TASK 6
    ...
    - ProjectManager instances have the following methods:
        + `standUp` a method that takes in a slack channel and returns `{name} announces to {channel}, @channel stanby times!`
